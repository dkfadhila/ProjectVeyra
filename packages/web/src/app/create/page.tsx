...
export default function CreatePage() {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      localStorage.setItem("veyra_tutorial_done", "false");
      router.push("/game");
    } catch (err: any) {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-8">
      <div className="text-center mb-10">
        ...
        <h1 className="text-5xl font-bold bg-gradient-to-r from-veyra-purple via-veyra-cyan to-veyra-pink bg-clip-text text-transparent mb-3">
          PROJECT VEYRA
        </h1>
        <p className="text-lg text-gray-400">Who will you become?</p>
      </div>
