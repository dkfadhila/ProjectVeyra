export const QUESTS = {
  welcome_to_veyra: {
    ...
    dialogue: {
      offer: 'Welcome, traveler! I am Lyra, merchant of Lunaris. Every great adventure begins with a conversation.',
      inProgress: 'Come speak with me at the marketplace. I\'ve been waiting for someone interesting.',
      complete: 'Wonderful! You\'ve taken your first step. The Azure Coast awaits.',
    },
  },
  first_hunt: {
    ...
    dialogue: {
      offer: 'The Tide Slimes have been troubling the coast merchants. Would you help?',
  ...
  crab_crisis: {
    ...
    dialogue: {
      offer: 'The Sand Crabs are swarming! The traders can\'t get through.',
